...
${LIBEVHTP_MAKEFILE}: ${LIBEVHTP_BUILD_DIR}
	cd ${LIBEVHTP_BUILD_DIR} && cmake ${LIBEVHTP_DIR} -DEVHTP_DISABLE_SSL=ON -DCMAKE_BUILD_TYPE=RelWithDebInfo -DEVHTP_DISABLE_REGEX=ON -DCMAKE_INSTALL_PREFIX=${PRE_INSTALL_DIR}
