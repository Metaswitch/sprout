...
/// Mangelwurzel constructor.
Mangelwurzel::Mangelwurzel():
  Sproutlet("mangelwurzel")
{
}

/// Mangelwurzel destructor.
Mangelwurzel::~Mangelwurzel()
{
}
...
SproutletTsx* Mangelwurzel::get_tsx(SproutletTsxHelper* helper,
                                     ...
                                     pjsip_msg* req)
{
  return (SproutletTsx*)new MangelwurzelTsx(helper, this);
}

/// Individual Tsx constructor.
MangelwurzelTsx::MangelwurzelTsx(SproutletTsxHelper* helper,
                                 Mangelwurzel* mangelwurzel) :
  SproutletTsx(helper),
  _mangelwurzel(mangelwurzel)
{
}

/// Tsx destructor.
MangelwurzelTsx::~MangelwurzelTsx()
{
}
...
void MangelwurzelTsx::on_cancel(int status_code, pjsip_msg* cancel_req)
{
}
