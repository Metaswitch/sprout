...
namespace SASEvent
{
  ...
  const int SPROUTLET_BEGIN_REQ = SPROUT_BASE + 0x0000EC;
  const int SPROUTLET_END_REQ = SPROUT_BASE + 0x0000ED;
  const int SPROUTLET_BEGIN_RSP = SPROUT_BASE + 0x0000EE;
  const int SPROUTLET_END_RSP = SPROUT_BASE + 0x0000EF;
