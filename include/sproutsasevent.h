...
namespace SASEvent
{
  ...
  const int IMPISTORE_IMPI_SET_SUCCESS = SPROUT_BASE + 0x000094;
  const int IMPISTORE_IMPI_GET_SUCCESS = SPROUT_BASE + 0x000095;
  const int IMPISTORE_IMPI_SET_FAILURE = SPROUT_BASE + 0x000096;
