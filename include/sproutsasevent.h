...
namespace SASEvent
{
  ...
  const int INVALID_IFC_IGNORED = SPROUT_BASE + 0x0000CB;
  ...
  const int CANCELLING_TSX = SPROUT_BASE + 0x0000ED;
  const int UAC_TSX_FAILED_NO_RESPONSE = SPROUT_BASE + 0x0000EE;
