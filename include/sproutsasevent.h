...
namespace SASEvent
{
  ...
  const int AUTHENTICATION_NOT_NEEDED_NOT_SCSCF_PORT = SPROUT_BASE + 0x000040;
  const int AUTHENTICATION_NOT_NEEDED_EMERGENCY_REGISTER = SPROUT_BASE + 0x000041;
  const int AUTHENTICATION_NOT_NEEDED_INTEGRITY_PROTECTED = SPROUT_BASE + 0x000042;
  const int AUTHENTICATION_NOT_NEEDED_PROXY_AUTHORIZATION = SPROUT_BASE + 0x000043;
  const int AUTHENTICATION_NEEDED_PROXY_AUTHORIZATION = SPROUT_BASE + 0x000044;
  const int AUTHENTICATION_CHALLENGE_AKA = SPROUT_BASE + 0x000045;
  const int AUTHENTICATION_CHALLENGE_DIGEST = SPROUT_BASE + 0x000046;
  const int AUTHENTICATION_FAILED_OVERLOAD = SPROUT_BASE + 0x000047;
  const int AUTHENTICATION_FAILED_MALFORMED = SPROUT_BASE + 0x000048;
  const int AUTHENTICATION_FAILED_NO_AV = SPROUT_BASE + 0x000049;
  const int AUTHENTICATION_FAILED = SPROUT_BASE + 0x00004A;
  const int AUTHENTICATION_SUCCESS = SPROUT_BASE + 0x00004B;
  const int AUTHENTICATION_TIMER_POP_IGNORED = SPROUT_BASE + 0x00004C;
  ...
  const int AVSTORE_SET_SUCCESS = SPROUT_BASE + 0x000090;
  const int AVSTORE_GET_SUCCESS = SPROUT_BASE + 0x000091;
  const int AVSTORE_SET_FAILURE = SPROUT_BASE + 0x000092;
  const int AVSTORE_GET_FAILURE = SPROUT_BASE + 0x000093;
