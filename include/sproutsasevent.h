...
namespace SASEvent
{
  ...
  const int BINDING_EXPIRED = SPROUT_BASE + 0x000070;
  const int SUBSCRIPTION_EXPIRED = SPROUT_BASE + 0x000071;

  const int REGISTER_START = SPROUT_BASE + 0x000080;
  const int REGISTER_FAILED = SPROUT_BASE + 0x000081;
  const int REGISTER_IRS_INVALID = SPROUT_BASE + 0x000082;
  const int REGISTER_FAILED_GET_BINDINGS = SPROUT_BASE + 0x000083;
  ...
  const int REGISTER_NO_CONTACTS = SPROUT_BASE + 0x000088;
  const int REGISTER_FAILED_5636 = SPROUT_BASE + 0x000089;
  const int REGISTER_EMERGENCY = SPROUT_BASE + 0x00008A;
  ...
  const int NO_SERVED_USER_OVERRIDING_ROUTE = SPROUT_BASE + 0x0000F2;
  const int NO_SERVED_USER_URI_NOT_LOCAL = SPROUT_BASE + 0x0000F3;
  ...
  const int SPROUTLET_REMOTE_ALIAS_MATCH_ACCEPT = SPROUT_BASE + 0x0115;
  const int SPROUTLET_REMOTE_ALIAS_MATCH_REJECT = SPROUT_BASE + 0x0116;
  ...
  const int AS_REGISTER_START = SPROUT_BASE + 0x0190;
  const int AS_REGISTER_FAILED = SPROUT_BASE + 0x0191;
  const int AS_DEREGISTER_FAILED = SPROUT_BASE + 0x0192;

  const int REGISTRATION_EXPIRED = SPROUT_BASE + 0x01A0;
} //namespace SASEvent
