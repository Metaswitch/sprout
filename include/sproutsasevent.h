...
namespace SASEvent
{
  ...
  const int IMPISTORE_IMPI_GET_SUCCESS = SPROUT_BASE + 0x000094;
  const int IMPISTORE_IMPI_GET_FAILURE = SPROUT_BASE + 0x000095;
  const int IMPISTORE_IMPI_SET_SUCCESS = SPROUT_BASE + 0x000096;
  const int IMPISTORE_IMPI_SET_FAILURE = SPROUT_BASE + 0x000097;
  const int IMPISTORE_IMPI_DELETE_SUCCESS = SPROUT_BASE + 0x000098;
  const int IMPISTORE_IMPI_DELETE_FAILURE = SPROUT_BASE + 0x000099;
  const int IMPISTORE_AV_GET_SUCCESS = SPROUT_BASE + 0x00009A;
  const int IMPISTORE_AV_GET_FAILURE = SPROUT_BASE + 0x00009B;
  const int IMPISTORE_AV_SET_SUCCESS = SPROUT_BASE + 0x00009C;
  const int IMPISTORE_AV_SET_FAILURE = SPROUT_BASE + 0x00009D;
  const int IMPISTORE_AV_DELETE_SUCCESS = SPROUT_BASE + 0x00009E;
  const int IMPISTORE_AV_DELETE_FAILURE = SPROUT_BASE + 0x00009F;
