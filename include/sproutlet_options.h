/**
 * @file sproulet_options.h  Sproutlet configuration options.
 *
...
// Set up ENUM types for each Sproutlet
#define SPROUTLET_ENUM_TYPES(NAME, NAME_LOWER, NAME_AS_STR)                    \
  OPT_PREFIX_##NAME,                                                           \
  OPT_PORT_##NAME,                                                             \
  OPT_URI_##NAME,
...
#define SPROUTLET_OPTIONS(NAME, NAME_LOWER, NAME_AS_STR)                       \
    case OPT_PORT_##NAME:                                                      \
      {                                                                        \
        ...
        {                                                                      \
          CL_SPROUT_INVALID_PORT_SPROUTLET.log("##NAME", pj_optarg);           \
          TRC_ERROR("##NAME port %s is invalid\n", pj_optarg);                 \
          return -1;                                                           \
        }                                                                      \
        break;                                                                 \
      }                                                                        \
    ...
    case OPT_PREFIX_##NAME:                                                    \
      {                                                                        \
        ...
        TRC_INFO("#NAME prefix set to = %s", pj_optarg);                       \
        break;                                                                 \
      }                                                                        \
                                                                               \
    case OPT_URI_##NAME:                                                       \
      {                                                                        \
        ...
        TRC_INFO("#NAME URI set to = %s", pj_optarg);                          \
        break;                                                                 \
      }
...
#define SPROUTLET_VERIFY_OPTIONS(NAME, NAME_LOWER, NAME_AS_STR)                \
  ...
  {                                                                            \
    ...
    {                                                                          \
      TRC_INFO("NAME disabled");                                               \
      opt.enabled_##NAME_LOWER = false;                                        \
    }                                                                          \
    else                                                                       \
    {                                                                          \
      TRC_INFO("NAME enabled on %d", opt.port_##NAME_LOWER);                   \
  ...
  {                                                                            \
    TRC_ERROR("NAME enabled, but no NAME URI specified");                      \
    return 1;                                                                  \
  }
