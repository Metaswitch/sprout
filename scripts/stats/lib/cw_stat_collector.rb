...
CWStatCollector.register_renderer("hss_assoc_uri_latency_us", LatencyStatsRenderer)
CWStatCollector.register_renderer("hss_ifc_latency_us", LatencyStatsRenderer)
