                                                      ...
                                                      const std::string& reason)
{
  ...
  if (i != _umap.end())
  {
    ...
    std::function<void()> fn = [this, upstream_sproutlet, fork_error, upstream_fork]() -> void
    {
    ...
    Callback* cb = new Callback(this, fn);

    // This prevents this UASTsx from being destroyed until this Callback is run
    _pending_callbacks++;
