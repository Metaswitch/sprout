...
public:
  ...
  SubscriptionTest()
  {
    ...
    _sdm->set_aor_data(aor, SubscriberDataManager::EventTrigger::TIMEOUT, aor_pair, 0);
...
TEST_F(SubscriptionTest, NoNotificationsForEmergencyRegistrations)
{
  ...
  AssociatedURIs associated_uris = {};
  associated_uris.add_uri(aor, false);
  _sdm->set_aor_data(aor, SubscriberDataManager::EventTrigger::TIMEOUT, aor_data1, 0);
