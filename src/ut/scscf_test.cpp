...
// Test that if a user has a mix of real and dummy application servers, only
// the real application servers are triggered.
TEST_F(SCSCFTest, InvokeMMFPrePostApplicationServer)
{
  register_uri(_sdm, _hss_connection, "6505551234", "homedomain", "sip:wuntootreefower@10.114.61.213:5061;transport=tcp;ob");
  _hss_connection->set_impu_result("sip:6505551000@homedomain", "call", "UNREGISTERED",
                                "<IMSSubscription><ServiceProfile>\n"
                                ...
                                "  </TriggerPoint>\n"
                                "  <ApplicationServer>\n"
                                "    <ServerName>sip:test.both.pre.post.mmf:56789;transport=UDP</ServerName>\n"
                                "    <DefaultHandling>0</DefaultHandling>\n"
                                "  </ApplicationServer>\n"
                                "  </InitialFilterCriteria>\n"
                                "  <InitialFilterCriteria>\n"
  ...
  SCSCFSproutletTsx SCSTsx = SCSCFSproutletTsx(_scscf_sproutlet, req_type);
  SCSTsx.route_to_as(req, "test.mmf.server.name");
  //poll();
  //ASSERT_EQ(2, txdata_count());
//
//  //// 100 Trying goes back to bono
...
// Test that if a user has a mix of real and dummy application servers, only
// the real application servers are triggered.
TEST_F(SCSCFTest, InvokeMMFPreApplicationServer)
{
  register_uri(_sdm, _hss_connection, "6505551234", "homedomain", "sip:wuntootreefower@10.114.61.213:5061;transport=tcp;ob");
  _hss_connection->set_impu_result("sip:6505551000@homedomain", "call", "UNREGISTERED",
                                "<IMSSubscription><ServiceProfile>\n"
                                ...
                                "  </TriggerPoint>\n"
                                "  <ApplicationServer>\n"
                                "    <ServerName>sip:test.mmf.server.name:56789;transport=UDP</ServerName>\n"
                                "    <DefaultHandling>0</DefaultHandling>\n"
                                "  </ApplicationServer>\n"
                                "  </InitialFilterCriteria>\n"
                                "  <InitialFilterCriteria>\n"
