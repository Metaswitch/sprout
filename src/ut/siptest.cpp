                           ...
                           bool add_tel)
{
  ...
  if (add_subscription)
  {
    ...
    subscriptions._subscriptions_map = {(std::make_pair(AoRTestUtils::SUBSCRIPTION_ID, subscription))};
    HTTPCode ret = sm->update_subscriptions(sip_uri, subscriptions, irs_info, 0);
