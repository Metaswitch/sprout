...
/// Simple correct example with Authorization header marked as integrity
/// protected
TEST_F(RegistrarTest, SimpleMainlineAuthHeaderWithIntegrityProtected)
{
  ...
  msg._auth = "Authorization: Digest response="", username=\"6505550231@homedomain\", nonce=\"\",integrity-protected=ip-assoc-yes\"";
