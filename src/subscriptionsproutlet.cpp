                  ...
                  std::map<SubscriberDataManager*, AoRPair*>& _cached_aors)
{
  ...
  if (current_subscription->_notify_cseq < new_subscription._notify_cseq)
  {
    current_subscription->_notify_cseq = new_subscription._notify_cseq;
  }
  else
  {
    new_subscription._notify_cseq = current_subscription->_notify_cseq;
  }
}
