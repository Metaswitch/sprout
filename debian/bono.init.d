...
do_start()
{
        ...
        get_settings
        DAEMON_ARGS="--system $NAME@$public_hostname --domain $home_domain --localhost $public_hostname --alias bono.$home_domain,$public_ip --trusted-port 5058 --untrusted-port 5060 --edge-proxy $sprout_hostname:5054:$upstream_connections:$upstream_recycle_connections --sas $sas_server --pjsip-threads $num_pjsip_threads --worker-threads $num_worker_threads -a $log_directory -F $log_directory -L $log_level"
